...
import np.com.cbikas.todoapp2020.ui.recycle_view_adapter.UpcomingAdapter;
...
public class NotDoneyet extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final UpcomingAdapter upcomingAdapter=new UpcomingAdapter();
        ...
        taskViewModel.getNewTask().observe(getViewLifecycleOwner(), new Observer<List<TodoEntity>>() {
            @Override
            public void onChanged(List<TodoEntity> todoEntities) {

                upcomingAdapter.setTask(todoEntities);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                taskViewModel.delete(upcomingAdapter.gettaskAt(viewHolder.getAdapterPosition()));
                Toast.makeText(getActivity(),"Note Deleted",Toast.LENGTH_SHORT).show();
            }
        })
                .attachToRecyclerView(recyclerView);

        upcomingAdapter.setOnItemClickListener(new UpcomingAdapter.OnItemClickListener() {
            @Override
